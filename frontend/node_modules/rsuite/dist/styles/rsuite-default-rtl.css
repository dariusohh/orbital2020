...
[dir='rtl'] .rs-carousel-slider-after {
  animation: moveLeftHalf 0.3s reverse ease forwards;
}
.rs-carousel-toolbar {
  display: -webkit-box;
  display: -ms-flexbox;
...
.rs-check-tree-node-expand-icon-wrapper > .rs-check-tree-node-expand-icon {
  ...
  font-size: 14px;
  line-height: 1.42857143;
  -webkit-transform:  rotate(90deg) translateX(-8px) translateY(-10px) ;
          transform:  rotate(90deg) translateX(-8px) translateY(-10px) ;
